...
const en = {
  ...
  'health.waiters': 'Waiters',
  'health.waitersRead': 'Read waiters',
  'health.waitersWrite': 'Write waiters',
  'health.uptime': 'Uptime',
  'health.replication': 'Replication state (contextCSN)',
  'health.replicationProvider': 'Provider',
  'health.replicationCsn': 'CSN',
  'health.replicationTimestamp': 'Timestamp',
  'health.noReplication': 'No replication contextCSN reported.',
  'health.logsTitle': 'Recent access logs',
  'health.logsSubtitle': 'Last 50 operations recorded by cn=accesslog (filters redacted, attribute names only).',
  'health.noLogs': 'No recent accesslog records found.',
  'health.logTime': 'Time',
  'health.logOp': 'Operation',
  'health.logActor': 'Actor',
  'health.logTarget': 'Target',
  'health.logDetails': 'Details',
  'health.logResult': 'Result',
  ...
  'history.title': 'Operator action history',
  'history.subtitle': 'Directory modifications recorded by cn=accesslog (values and passwords redacted).',
  'history.loading': 'Loading action history…',
  'history.loadFailed': 'Failed to load action history',
  'history.permissionDeniedTitle': "Your account can't read cn=accesslog",
  'history.permissionDeniedBody':
    'cn=accesslog is restricted by directory ACLs. Grant your bind DN read access to cn=accesslog to inspect operator history.',
  'history.filterActor': 'Filter by actor',
  'history.filterOp': 'Filter by operation',
  'history.allOps': 'All operations',
  'history.colTime': 'Time',
  'history.colOp': 'Operation',
  'history.colActor': 'Actor',
  'history.colTarget': 'Target',
  'history.colAttrs': 'Modified attributes',
  'history.colResult': 'Result',
  'history.prev': 'Previous',
  'history.next': 'Next',
  'history.refresh': 'Refresh',
  'history.noEvents': 'No actions found',
  'history.noEventsDesc': 'No operator action history matching the criteria was found in cn=accesslog.',
