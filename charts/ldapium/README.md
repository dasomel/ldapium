...
| `LDAPiumPeerUnreachable` | dial failures to a peer or local endpoint over `peerUnreachableFor` | Network connectivity or peer pod crash. Check peer headless Service DNS resolution, network policies, and peer container status. |
