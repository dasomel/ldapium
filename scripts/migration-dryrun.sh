...
# collisions, structural objectClass requirements, base DN boundaries, and — for an LDIF
# generated by an external SCIM bridge or IdP-sync tool — a "ldapium-attribute-mapping-schema-version"
# compatibility gate (see docs/client-compatibility.md, "Standard attribute mapping and
# schema versioning contract for SCIM bridges").
#
